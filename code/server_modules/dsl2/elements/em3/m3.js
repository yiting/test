...
class EM3M3 extends Model.ElementModel {
    ...
    regular1() {
        return Feature.directionAleftToB(this._tagTxt, this._mainTxt)
                && Feature.directionAleftToB(this._tagIcon, this._mainTxt);
    }
    ...
    regular3() {
        ...
        return Feature.distanceGreatArightToBleft(this._tagIcon, this._mainTxt, 0)
                && Feature.distanceLessArightToBleft(this._tagIcon, this._mainTxt, 22);
    }
