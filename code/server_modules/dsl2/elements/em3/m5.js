...
class EM3M5 extends Model.ElementModel {
    constructor() {
        // 元素构成规则
    ...
    regular1() {
        return Feature.directionAleftToB(this._tagTxt, this._mainTxt)
                && Feature.directionAleftToB(this._tagImage, this._mainTxt);
    }
    ...
    regular3() {
        ...
        return Feature.distanceGreatArightToBleft(this._tagImage, this._mainTxt, 0)
                && Feature.distanceLessArightToBleft(this._tagImage, this._mainTxt, 22);
    }
