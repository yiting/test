...
class DSLTreeProcessor {
    ...
    static _parseWidgetNode(node, dslTree, platformType) {
        ...
        let jsonNode = matchData.getMatchNode();
        let styles = {};
...
function walkModel(matchData, handler, node) {
    ...
    if (~matchData.modelName.indexOf('em1') && node && node.children) Object.assign(structure[0], {
        children: node.children
    });
    for (let key in structure) {
        if (structure[key] && structure[key].constructor.name === 'MatchData') {
