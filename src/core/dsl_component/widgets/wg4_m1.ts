...
class WG4M1 extends BaseModel {
  ...
  regular1() {
    ...
    let bool = Feature.directionAleftToB(this.matchNodes['0'], this.matchNodes['1'])
                ...
                && Feature.directionAleftToB(this.matchNodes['0'], this.matchNodes['3']);
    return bool;
  }
  ...
  // 三个文字位于垂直轴
  regular3() {
    let bool = Feature.baselineGroupAInVertical([this.matchNodes['1'], this.matchNodes['2'], this.matchNodes['3']]);
    return bool;
  }
  ...
  regular5() {
    ...
    let bool = Feature.distanceGreatAbottomToBtop(this.matchNodes['1'], this.matchNodes['2'], 0)
                ...
                && Feature.distanceGreatAbottomToBtop(this.matchNodes['2'], this.matchNodes['3'], 0)
                && Feature.distanceLessAbottomToBtop(this.matchNodes['2'], this.matchNodes['3'], 44);
    return bool;
  }
}
