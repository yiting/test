...
class EM2M3 extends Model.ElementModel {
    ...
    regular1() {
        // 文字位于图标
        return Feature.directionArightToB(this._matchNodes['0'], this._matchNodes['1']);
    }
    ...
    regular3() {
        ...
        return Feature.distanceGreatArightToBleft(this._matchNodes['1'], this._matchNodes['0'], -4)
                && Feature.distanceLessArightToBleft(this._matchNodes['1'], this._matchNodes['0'], 24);
    }
