...
class EM3M2 extends Model.ElementModel {
    ...
    _initNode() {
        ...
        this._matchNodes['0'] = this._tagShape; // tag的shape背景
        this._matchNodes['1'] = this._tagTxt; // tag的文字
        this._matchNodes['2'] = this._mainTxt; // 主文字
    }

    // 元素方向
    regular1() {
        return Feature.directionAleftToB(this._mainTxt, this._tagTxt) &&
            Feature.directionAleftToB(this._mainTxt, this._tagShape);
    }
